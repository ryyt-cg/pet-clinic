...
TDD is a practice to write tests first

## Testify


## [Mockery](https://vektra.github.io/mockery/latest/)
Mockery is a tool used to generate mock implementations on Go interfaces. It is useful when you are writing unit tests for your code and you need to mock the dependencies of the code under test.
...
Use go tool to install the version of mockery
```shell
