...
func (_m *MockServicer) getOwnerByIdWithPets(id uint) (*Responses, error) {
	ret := _m.Called(id)
	...
	var r0 *Responses
	var r1 error
	if rf, ok := ret.Get(0).(func(uint) (*Responses, error)); ok {
		return rf(id)
	}
	if rf, ok := ret.Get(0).(func(uint) *Responses); ok {
		r0 = rf(id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*Responses)
...
func (_c *MockServicer_getOwnerByIdWithPets_Call) Return(_a0 *Responses, _a1 error) *MockServicer_getOwnerByIdWithPets_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockServicer_getOwnerByIdWithPets_Call) RunAndReturn(run func(uint) (*Responses, error)) *MockServicer_getOwnerByIdWithPets_Call {
	_c.Call.Return(run)
	return _c
}
