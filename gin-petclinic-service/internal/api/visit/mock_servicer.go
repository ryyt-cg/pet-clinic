...
// create provides a mock function with given fields: visit
func (_m *MockServicer) create(visit *Request) (*Response, error) {
	ret := _m.Called(visit)
...
func (_c *MockServicer_create_Call) RunAndReturn(run func(*Request) (*Response, error)) *MockServicer_create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockServicer) update(visit *Request) (*Response, error) {
	ret := _m.Called(visit)
...
func (_c *MockServicer_update_Call) RunAndReturn(run func(*Request) (*Response, error)) *MockServicer_update_Call {
	_c.Call.Return(run)
	return _c
}
