...
func (_m *MockOwnerRepositorier) FindById(id uint) (*Owner, error) {
	ret := _m.Called(id)
...
func (_c *MockOwnerRepositorier_FindById_Call) RunAndReturn(run func(uint) (*Owner, error)) *MockOwnerRepositorier_FindById_Call {
	_c.Call.Return(run)
	return _c
}
