...
func (_m *MockPetRepositorier) FindAll() ([]Pet, error) {
	ret := _m.Called()
	...
	var r0 []Pet
	var r1 error
	if rf, ok := ret.Get(0).(func() ([]Pet, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() []Pet); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]Pet)
...
func (_c *MockPetRepositorier_FindAll_Call) Return(_a0 []Pet, _a1 error) *MockPetRepositorier_FindAll_Call {
...
func (_m *MockPetRepositorier) FindByIdWithVisits(id int) (*Pet, error) {
	ret := _m.Called(id)
...
func (_c *MockPetRepositorier_FindByIdWithVisits_Call) Return(_a0 *Pet, _a1 error) *MockPetRepositorier_FindByIdWithVisits_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockPetRepositorier_FindByIdWithVisits_Call) RunAndReturn(run func(int) (*Pet, error)) *MockPetRepositorier_FindByIdWithVisits_Call {
	_c.Call.Return(run)
	return _c
}
