...
func (_m *MockVetRepositorier) FindAllSpecialties() ([]Specialty, error) {
	ret := _m.Called()
	...
	var r0 []Specialty
	var r1 error
	if rf, ok := ret.Get(0).(func() ([]Specialty, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() []Specialty); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockVetRepositorier_FindAllSpecialties_Call) Return(_a0 []Specialty, _a1 error) *MockVetRepositorier_FindAllSpecialties_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
func (_m *MockVetRepositorier) FindByIdWithSpecialties(id int) (*Vet, error) {
	ret := _m.Called(id)
...
func (_c *MockVetRepositorier_FindByIdWithSpecialties_Call) Return(_a0 *Vet, _a1 error) *MockVetRepositorier_FindByIdWithSpecialties_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockVetRepositorier_FindByIdWithSpecialties_Call) RunAndReturn(run func(int) (*Vet, error)) *MockVetRepositorier_FindByIdWithSpecialties_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_e *MockVetRepositorier_Expecter) Insert(vet interface{}) *MockVetRepositorier_Insert_Call {
	return &MockVetRepositorier_Insert_Call{Call: _e.mock.On("Fail", vet)}
}
