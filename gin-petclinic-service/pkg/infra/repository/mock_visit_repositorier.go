...
func (_m *MockVisitRepositorier) Insert(visit *Visit) (*Visit, error) {
	ret := _m.Called(visit)
	...
	var r0 *Visit
	var r1 error
	if rf, ok := ret.Get(0).(func(*Visit) (*Visit, error)); ok {
		return rf(visit)
	}
	...
	if rf, ok := ret.Get(1).(func(*Visit) error); ok {
		r1 = rf(visit)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockVisitRepositorier_Insert_Call) Return(_a0 *Visit, _a1 error) *MockVisitRepositorier_Insert_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockVisitRepositorier_Insert_Call) RunAndReturn(run func(*Visit) (*Visit, error)) *MockVisitRepositorier_Insert_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function with given fields: visit
func (_m *MockVisitRepositorier) Update(visit *Visit) (*Visit, error) {
	ret := _m.Called(visit)
...
func (_c *MockVisitRepositorier_Update_Call) Return(_a0 *Visit, _a1 error) *MockVisitRepositorier_Update_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockVisitRepositorier_Update_Call) RunAndReturn(run func(*Visit) (*Visit, error)) *MockVisitRepositorier_Update_Call {
	_c.Call.Return(run)
	return _c
}
