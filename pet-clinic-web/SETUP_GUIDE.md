...
Steps to set up a Vite project with React, TypeScript, Tailwind CSS, Shadcn/UI, TanStack Router, and TanStack Query.

## Step 1: Setting Up Vite with React and TypeScript
...
## Step 2: [Adding TanStack Router](https://tanstack.com/router/latest)
